define(['./module'
	...
	app.controller('AccountBFAController', ['$scope', '$filter', '$mdDialog', 'AccountResource', 'AccountEntryResource', 'SubCategoryResource', 'Utils',
        function($scope, $filter, $mdDialog, Account, AccountEntry, SubCategory, Constants, Utils) {
            ...
            $scope.edit = function(entry){
                ...
                $mdDialog.show({
                    ...
                    templateUrl: 'modules/account/views/new-account-BFA-entry-template.html',
            ...
            function DialogController($scope, $mdDialog, $filter, Utils, subCategories, entry, account) {
