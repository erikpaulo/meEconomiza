...
Shadows are a well-established feature in user interfaces, and provide users with a visual clue to an object's intended use or profit. Their design and use is an important factor in the overall user experience.
