...
- `amAdd`, `amSubtract` - add/subtract a profit from a given date ([#171](https://github.com/urish/angular-moment/pull/171), contributed by [nicholasruggeri](https://github.com/nicholasruggeri))
