 ...
 */
@Service
public class CreditCardAccountService extends CheckingAccountService {
     ...
     * @return
     */
    public CheckingAccountEntry updateEntry(CreditCardAccountEntry entry, Integer groupId){
     ...
     * @return
     */
    public CreditCardAccount getAccount(Integer accountId, Integer groupId){
        return (CreditCardAccount) super.getAccount(accountId, groupId);
    }
