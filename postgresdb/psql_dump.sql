...
CREATE TABLE PATRIMONY (
	...
	PROFIT_TOTAL            DECIMAL NOT NULL,
	PROFIT_INVESTED         DECIMAL NOT NULL,
	PERCENT_PROFIT_TOTAL    DECIMAL NOT NULL,
	PERCENT_PROFIT_INVESTED DECIMAL NOT NULL,
	USER_GROUP_ID           INTEGER NOT NULL REFERENCES USER_GROUP(id)
);
...
CREATE TABLE PATRIMONY_ENTRY (
	...
	PERCENT_PROFIT      DECIMAL NOT NULL,
	USER_GROUP_ID       INTEGER NOT NULL REFERENCES USER_GROUP(id)
);
